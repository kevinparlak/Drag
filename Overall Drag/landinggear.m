...
if airfoil==1
    ...
    ftire=(Cd_tirefairing*.75*d_tire*(w_tire/(wheel/100)))+(Cd_tire*.25*d_tire*w_tire);
else
...
if airfoil==1
    ...
    ftiremain=(2*Cd_tirefairing*.75*d_tiremain*(w_tiremain/(wheel/100)))+...
        (2*Cd_tire*.25*d_tiremain*w_tiremain);
else
