...
atmosphere.T=59+460; % R
atmosphere.rho=.002377; % slug/ft^3
atmosphere.mu=0.000000375;% lb s/ft 
...
%CL cruise = .73
%CL max = 1.6
CL=0.3:0.1:1.79; % CL range. You will change this so it covers about 0.2 to 1.6 i.e. CL=0.2:0.1:1.6
%{
