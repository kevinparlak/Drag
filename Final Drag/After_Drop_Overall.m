...
indexconstant=find(abs(v-177)<=10);
...
legend('front wing induced','rear wing induced','tail induced',...
    ...
    'fuselage','boom','landing gear','parasite','total','Minimum Drag','Constant Airspeed from Cruise','Location','NorthWest')
ylabel('Drag (lb)')
...
subplot(3,1,1)
plot(v_u,LD,Vbestknots,LDbest,'*',Vconstantknots,LDconstant,'o')
ylabel('L/D')
legend('LD profile','Minimum Drag','Constant Airspeed from Cruise')
subplot(3,1,2)
plot(v_u,D_tot,Vbestknots,Dbest,'*',Vconstantknots,Dconstant,'o')
ylabel('Drag (lb)')
legend('Total drag','Minimum Drag','Constant Airspeed from Cruise')
subplot(3,1,3)
plot(v_u,P.aero/550,Vbestknots,Pbest/550,'*',Vconstantknots,Pconstant/550,'o')
legend('Power required (hp)','Minimum Drag','Constant Airspeed from Cruise')
ylabel('Power (hp)')
xlabel('Airspeed (knots)')
axis([50,200,0,100])
...
fprintf('Airspeed after-drop (knots) = %f\n',Vbestknots)
