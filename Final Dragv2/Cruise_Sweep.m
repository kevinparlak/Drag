...
subplot(3,1,1)
plot(v,LD,Vbest,LDbest,'*',Vincrease,LDincrease,'o')
ylabel('L/D')
legend('LD profile','Minimum Drag','Increased Power')
subplot(3,1,2)
plot(v,D_tot,Vbest,Dbest,'*',Vincrease,Dincrease,'o')
ylabel('Drag (lb)')
legend('Total drag','Minimum Drag','Increased Power')
subplot(3,1,3)
plot(v,P.aero/550,Vbest,Pbest/550,'*',Vincrease,Pincrease/550,'o')
legend('Power required (hp)','Minimum Drag','Increased Power')
ylabel('Power (hp)')
